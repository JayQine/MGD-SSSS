...
default_cfgs = {
    ...
    'wide_resnet18_2': _cfg(url='https://download.pytorch.org/models/resnet18-5c106cde.pth'),
    'resnet18d': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/resnet18d_ra2-48a79e06.pth',
        interpolation='bicubic', first_conv='conv1.0'),
    'resnet34': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/resnet34-43635321.pth'),
    'wide_resnet34_2': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/resnet34-43635321.pth'),
    'resnet34d': _cfg(
...
def wide_resnet18_2(pretrained_model=None, **kwargs):
    ...
    pretrained = False
    model = _create_resnet('wide_resnet18_2', pretrained, **model_args)
...
@register_model
def wide_resnet34_2(pretrained_model=False, **kwargs):
    """Constructs a Wide ResNet-50-2 model.
    The model is the same as ResNet except for the bottleneck number of channels
    which is twice larger in every block. The number of channels in outer 1x1
    convolutions is the same, e.g. last block in ResNet-50 has 2048-512-2048
    ...
    pretrained_ckpt = "../../DATA/model-weight/checkpoint-wres34.pth.tar"
