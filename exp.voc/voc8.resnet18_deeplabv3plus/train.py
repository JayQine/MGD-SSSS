...
with Engine(custom_parser=parser) as engine:
    ...
    model_dict1 = torch.load(config.pretrained_tea1, map_location=torch.device('cpu'))['model']
    ...
    model_dict2 = torch.load(config.pretrained_tea2, map_location=torch.device('cpu'))['model']
