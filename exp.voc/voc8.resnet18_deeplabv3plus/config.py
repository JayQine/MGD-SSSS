...
C.pretrained_model = C.volna + 'DATA/model-weight/resnet50_v1c.pth'
C.pretrained_tea1 = C.volna + 'DATA/model-weight/teacher-voc8-wideresnet34.pth'
C.pretrained_tea2 = C.volna + 'DATA/model-weight/teacher-voc8-resnet101.pth'
